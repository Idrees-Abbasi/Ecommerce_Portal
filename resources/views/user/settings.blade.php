                        ...
                        <div class="col-xl-8 col-md-8">
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="text" class="form-control " placeholder="idrees">
                                </div>
                                <div class="col-lg-6 mb-3">
                                    <label class="form-label">Last Name</label>
                                    <input type="text" class="form-control " placeholder="abbasi">
                                </div>
                        ...
                        <div class="col-xl-12 col-md-12">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="text" class="form-control " placeholder="143001">
                                </div>

                                <div class="col-lg-6 mb-3">
                                    <label class="form-label">Landmark</label>
                                    <input type="text" class="form-control " placeholder="Near Park">
                                </div>
